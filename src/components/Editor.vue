<template>
    ...
    <section class="editor-container"
      ...
      <textarea id="editor_md"
            ...
            <textarea name="content_html" :value="content_html"
...
<g fill="none" fill-rule="evenodd" transform="translate(1 1)">
    ...
    <span class="lang">${languageStr}</span>
            ...
            scrollLink: function (event, who, editor, preview) {
            ...
            onScrollEditor(event) {
                this.scrollLink(event, 'editor', this.$refs.editorBox, this.$refs.preview);
            },
            //滚动预览事件
            onScrollPreview() {
                this.scrollLink(event, 'preview', this.$refs.editorBox, this.$refs.preview);
            },
        }
    }
</script>
